  ...
  return (
    ...
    >
      <motion.div
        ...
        className="w-full max-w-3xl overflow-hidden rounded-[32px] border border-white/10 bg-[#17181a] shadow-2xl"
      >
        <div className="flex items-center justify-between border-b border-white/5 bg-white/5 px-6 py-5">
          <div>
            <h3 className="text-lg font-semibold text-white">Diagnostic de couche</h3>
            <p className="mt-1 text-sm text-white/45">{layerName}</p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="max-h-[75vh] overflow-y-auto p-6 chat-scrollbar">
          {isLoading ? (
            <div className="flex items-center gap-3 rounded-3xl border border-white/10 bg-white/5 p-5 text-white/65">
            ...
            <div className="space-y-5">
              <div className="grid gap-3 md:grid-cols-3">
                <div className="rounded-3xl border border-white/10 bg-white/5 p-4">
                  <p className="text-[11px] uppercase tracking-[0.18em] text-white/35">Type</p>
                ...
                <div className="rounded-3xl border border-white/10 bg-white/5 p-4">
                  <p className="text-[11px] uppercase tracking-[0.18em] text-white/35">CRS</p>
                  <p className="mt-2 text-sm font-semibold text-white">
                    {diagnostics.crs || "Inconnu"}
                  </p>
                </div>
                <div className="rounded-3xl border border-white/10 bg-white/5 p-4">
                  <p className="text-[11px] uppercase tracking-[0.18em] text-white/35">Entités</p>
                  <p className="mt-2 text-sm font-semibold text-white">
              ...
              <div className="grid gap-3 md:grid-cols-3">
                ...
                <div className="rounded-3xl border border-orange-500/20 bg-orange-500/8 p-4">
                  <p className="text-[11px] uppercase tracking-[0.18em] text-orange-100/60">
                    Géométries vides
                  </p>
                  <p className="mt-2 text-2xl font-semibold text-white">
              ...
              {diagnostics.warnings.length > 0 && (
                <div className="rounded-3xl border border-amber-500/20 bg-amber-500/8 p-5">
                  <p className="text-sm font-semibold text-white">Alertes</p>
              ...
              {diagnostics.extent && (
                <div className="rounded-3xl border border-white/10 bg-white/5 p-5">
                  <p className="text-sm font-semibold text-white">Emprise</p>
              ...
              <div className="rounded-3xl border border-white/10 bg-white/5 p-5">
                <p className="text-sm font-semibold text-white">Qualité des champs</p>
                    ...
                    >
                      <div className="flex items-center justify-between gap-3">
                        <div>
                          ...
                          <p className="text-xs text-white/45">{field.type}</p>
                        </div>
