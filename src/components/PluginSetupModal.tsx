  ...
  return (
    ...
    >
      <motion.div
        ...
        className="w-full max-w-2xl overflow-hidden rounded-[32px] border border-[#333537] bg-white dark:bg-[#1a1a1b] shadow-2xl"
      >
        <div className="flex items-center justify-between border-b border-[#333537] bg-gradient-to-r from-blue-600/10 to-transparent p-6">
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-blue-600/20 text-blue-400">
              <Code2 size={24} />
            </div>
            <div>
              <h3 className="text-lg font-bold text-white">Installation du plugin QGIS</h3>
          ...
          <button
            onClick={onClose}
            className="rounded-full p-2 text-[#8e918f] transition-colors hover:bg-white/5 hover:text-white"
          >
            <X size={20} />
          </button>
        </div>
        ...
        <div className="max-h-[70vh] space-y-6 overflow-y-auto p-6 chat-scrollbar">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <h4 className="text-sm font-semibold text-white">Structure attendue du plugin</h4>
              <button
                onClick={async () => {
            ...
            <div className="overflow-x-auto rounded-2xl border border-[#333537] bg-[#0a0a0a] p-4 font-mono text-xs text-blue-300/80">
          ...
          <div className="flex gap-4 rounded-3xl border border-blue-500/20 bg-blue-600/10 p-4">
            ...
            <div className="space-y-1">
              <p className="text-sm font-semibold text-blue-100">Étapes d'installation</p>
        ...
        <div className="flex justify-end border-t border-[#333537] bg-white dark:bg-[#1a1a1b] p-6">
          <button
            onClick={onClose}
